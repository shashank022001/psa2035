...
public class EmployeeController {
 ...
 // http://localhost:5000/api/v1/employee?id=1
  @DeleteMapping
  public  ResponseEntity<String> deleteEmployee(@RequestParam Long id) {
    ...
    // http://localhost:5000/api/v1/employee?pageSize=3&pageNo=1&sortBy=email&sortDir=asc
    @GetMapping
    ...
    // http://localhost:5000/api/v1/employee/employeeId/1
